 ...
 */
class MultiScoperSlider
    : public ThemedComponent
    , public TestIdSupport
    , private juce::Timer
{
public:
    MultiScoperSlider(IThemeService& themeService);
    MultiScoperSlider(IThemeService& themeService, SliderVariant variant);
    MultiScoperSlider(IThemeService& themeService, const juce::String& testId);
    MultiScoperSlider(IThemeService& themeService, SliderVariant variant, const juce::String& testId);
    ~MultiScoperSlider() override;
...
private:
    ...
    // Rotary layout — shared source of truth across MultiScoperSlider.cpp and MultiScoperSliderPainting.cpp.
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MultiScoperSlider)
};
