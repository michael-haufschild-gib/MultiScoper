/*
    MultiScoper - Color Swatches Component
 ...
 */
class MultiScoperColorSwatches
    : public ThemedComponent
    , public TestIdSupport
    , private juce::Timer
{
public:
    explicit MultiScoperColorSwatches(IThemeService& themeService, const juce::String& testId = "");
    ~MultiScoperColorSwatches() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MultiScoperColorSwatches)
};
