/*
    MultiScoper - Radio Button Component Painting
*/
...
void MultiScoperRadioButton::paint(juce::Graphics& g)
{
...
void MultiScoperRadioButton::paintCircle(juce::Graphics& g, const juce::Rectangle<float>& bounds)
{
    float const opacity = enabled_ ? 1.0f : ComponentLayout::DISABLED_OPACITY;
...
void MultiScoperRadioButton::paintDot(juce::Graphics& g, const juce::Rectangle<float>& bounds)
{
    float const opacity = enabled_ ? 1.0f : ComponentLayout::DISABLED_OPACITY;
...
void MultiScoperRadioButton::paintFocusRing(juce::Graphics& g, const juce::Rectangle<float>& bounds)
{
