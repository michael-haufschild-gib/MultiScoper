 ...
 */
class MultiScoperToggle
    : public ThemedComponent
    , public TestIdSupport
    , private juce::Timer
{
public:
    MultiScoperToggle(IThemeService& themeService);
    MultiScoperToggle(IThemeService& themeService, const juce::String& label);
    MultiScoperToggle(IThemeService& themeService, const juce::String& label, const juce::String& testId);
    ~MultiScoperToggle() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MultiScoperToggle)
};
