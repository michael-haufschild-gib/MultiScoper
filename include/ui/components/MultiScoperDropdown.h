/*
    MultiScoper - Dropdown Component
 ...
 */
class MultiScoperDropdownPopup
    : public ThemedComponent
    , private juce::Timer
{
public:
    /// Create a dropdown popup attached to the theme service.
    explicit MultiScoperDropdownPopup(IThemeService& themeService);
    ~MultiScoperDropdownPopup() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MultiScoperDropdownPopup)
};
...
public:
    ...
    MultiScoperDropdown(IThemeService& themeService);
    /// Create dropdown with placeholder text.
    MultiScoperDropdown(IThemeService& themeService, const juce::String& placeholder);
    /// Create dropdown with placeholder text and test ID.
    MultiScoperDropdown(IThemeService& themeService, const juce::String& placeholder, const juce::String& testId);
    ~MultiScoperDropdown() override;
...
private:
    ...
    std::unique_ptr<MultiScoperDropdownPopup> popup_;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MultiScoperDropdown)
};
