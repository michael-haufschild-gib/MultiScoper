 ...
 */
class MultiScoperBadge
    : public ThemedComponent
    , public TestIdSupport
{
public:
    MultiScoperBadge(IThemeService& themeService);
    MultiScoperBadge(IThemeService& themeService, const juce::String& text);
    MultiScoperBadge(IThemeService& themeService, const juce::String& text, BadgeColor color);
    MultiScoperBadge(IThemeService& themeService, const juce::String& text, BadgeColor color,
                     const juce::String& testId);
    ~MultiScoperBadge() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MultiScoperBadge)
};
