...
struct TimingConfig
{
     ...
     */
    static float getNoteIntervalMultiplier(NoteInterval interval)
    {
        switch (interval)
        {
            // Standard notes
            ...
            case NoteInterval::WHOLE:           return 4.0f;

            // Multi-bar
            case NoteInterval::TWO_BARS:        return 8.0f;
            case NoteInterval::THREE_BARS:      return 12.0f;
            case NoteInterval::FOUR_BARS:       return 16.0f;
            case NoteInterval::EIGHT_BARS:      return 32.0f;
