/*
    MultiScoper - Meter Bar Component
...
public:
    ...
    explicit MultiScoperMeterBar(IThemeService& themeService);
    MultiScoperMeterBar(IThemeService& themeService, const juce::String& testId);
    ~MultiScoperMeterBar() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MultiScoperMeterBar)
};
