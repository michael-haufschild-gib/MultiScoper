/*
    MultiScoper - Color Picker Painting & Gradient Cache
    (Core setup, events, and interaction are in MultiScoperColorPicker.cpp)
*/
...
void MultiScoperColorPicker::paint(juce::Graphics& g)
{
...
void MultiScoperColorPicker::paintSquareMode(juce::Graphics& g)
{
...
void MultiScoperColorPicker::paintWheelMode(juce::Graphics& g)
{
    auto bounds = getGradientBounds();
...
void MultiScoperColorPicker::updateSquareGradient(const juce::Rectangle<int>& bounds)
{
    cachedHue_ = hue_;
...
void MultiScoperColorPicker::updateGradientCache(const juce::Rectangle<int>& bounds)
{
...
void MultiScoperColorPicker::paintHueSlider(juce::Graphics& g, juce::Rectangle<int> bounds)
{
    if (bounds.getWidth() <= 0 || bounds.getHeight() <= 0)
        return;
...
void MultiScoperColorPicker::paintAlphaSlider(juce::Graphics& g, juce::Rectangle<int> bounds)
{
    // Checker background
...
void MultiScoperColorPicker::paintPreview(juce::Graphics& g, juce::Rectangle<int> bounds)
{
