...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "8.0.5"
  WORKING_DIRECTORY "/home/runner/work/MultiScoper/MultiScoper/_codeql_build_dir/_deps/juce-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/work/MultiScoper/MultiScoper/_codeql_build_dir/_deps/juce-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/work/MultiScoper/MultiScoper/_codeql_build_dir/_deps/juce-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
