/*
    MultiScoper - Test Fixtures

    Provides standardized test fixtures for different testing scenarios:
    - MultiScoperPluginTestFixture: For tests requiring full plugin (processor + editor)
    - MultiScoperComponentTestFixture: For tests of isolated UI components
    - MultiScoperStateTestFixture: For tests of state/model classes
*/
 ...
 *
 * Use this for:
 * - Tests involving MultiScoperPluginEditor
 * - Integration tests that need full plugin behavior
 * - Any test requiring real services
 */
class MultiScoperPluginTestFixture : public ::testing::Test
{
protected:
    void SetUp() override
    {
    ...
    void createEditor()
    {
        editor = std::make_unique<MultiScoperPluginEditor>(*processor);
    ...
    std::unique_ptr<MultiScoperPluginEditor> editor;
};
 ...
 * - Tests that don't require MultiScoperPluginEditor
 */
class MultiScoperComponentTestFixture : public ::testing::Test
{
protected:
    void SetUp() override
    {
 ...
 *
 * Use this for:
 * - Testing MultiScoperState, Oscillator, Pane, etc.
 * - Pure logic tests without UI dependencies
 */
class MultiScoperStateTestFixture : public ::testing::Test
{
protected:
    void SetUp() override
    {
 ...
 */
class MultiScoperTestFixture : public MultiScoperPluginTestFixture
{
protected:
