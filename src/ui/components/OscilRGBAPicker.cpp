/*
    Oscil - RGBA Picker Implementation
    Color selection with RGBA sliders and hex input
*/
...
void OscilRGBAPicker::paint(juce::Graphics& g)
{
...
void OscilRGBAPicker::setColour(juce::Colour colour)
{
...
void OscilRGBAPicker::setOpacity(float opacity)
{
...
bool OscilRGBAPicker::parseHexColour(const juce::String& hex, juce::Colour& outColour)
{
...
juce::String OscilRGBAPicker::toHexString(juce::Colour colour)
{
...
void OscilRGBAPicker::updateFromSliders()
{
    if (isUpdating_)
        return;
...
void OscilRGBAPicker::updateFromHex()
{
    if (isUpdating_)
        return;
...
void OscilRGBAPicker::updateControls()
{
    if (isUpdating_)
        return;
...
void OscilRGBAPicker::notifyColourChanged()
{
