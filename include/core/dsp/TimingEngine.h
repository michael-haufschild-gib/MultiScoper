...
enum class WaveformTriggerMode
{
    ...
    BothEdges       // Trigger on either rising or falling edge
};
 ...
 * @return Duration in beats (quarter notes)
 *
 * For bar-based intervals (1 Bar, 2 Bars, etc.), the duration depends on the
 * time signature. For example, "1 Bar" in 3/4 time = 3 beats, in 4/4 = 4 beats.
 */
