/*
    MultiScoper - Text Field Component
 ...
 */
class MultiScoperTextField
    : public ThemedComponent
    , public TestIdSupport
    , private juce::Timer
{
public:
    MultiScoperTextField(IThemeService& themeService);
    MultiScoperTextField(IThemeService& themeService, TextFieldVariant variant);
    MultiScoperTextField(IThemeService& themeService, const juce::String& testId);
    MultiScoperTextField(IThemeService& themeService, TextFieldVariant variant, const juce::String& testId);
    ~MultiScoperTextField() override;
    ...
    /// Request keyboard focus on the internal editor. The MultiScoperTextField wrapper
...
private:
    ...
    std::unique_ptr<MultiScoperButton> decrementButton_;
    std::unique_ptr<MultiScoperButton> incrementButton_;
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MultiScoperTextField)
};
