/*
    MultiScoper - Application-wide JUCE LookAndFeel Implementation
*/
...
MultiScoperLookAndFeel::MultiScoperLookAndFeel()
{
    regularTypeface_ =
        juce::Typeface::createSystemTypefaceFor(BinaryData::PTRootUIRegular_ttf, BinaryData::PTRootUIRegular_ttfSize);
    mediumTypeface_ =
        juce::Typeface::createSystemTypefaceFor(BinaryData::PTRootUIMedium_ttf, BinaryData::PTRootUIMedium_ttfSize);
    boldTypeface_ =
        juce::Typeface::createSystemTypefaceFor(BinaryData::PTRootUIBold_ttf, BinaryData::PTRootUIBold_ttfSize);
    lightTypeface_ =
        juce::Typeface::createSystemTypefaceFor(BinaryData::PTRootUILight_ttf, BinaryData::PTRootUILight_ttfSize);

    setDefaultSansSerifTypeface(regularTypeface_);
...
juce::Typeface::Ptr MultiScoperLookAndFeel::getTypefaceForFont(const juce::Font& font)
{
    const auto style = font.getTypefaceStyle().toLowerCase();
    if (style.contains("light"))
        return lightTypeface_;
    if (style.contains("medium"))
        return mediumTypeface_;
    if (font.isBold() || style.contains("bold"))
        return boldTypeface_;
    return regularTypeface_;
}

void MultiScoperLookAndFeel::applyTheme(const ColorTheme& theme)
{
