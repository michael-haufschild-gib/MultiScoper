...
1. **Audio thread** -- must never block. Budget: ~10.7ms per block at 48kHz/512 samples (512/48000); ~2.9ms at 48kHz/128 samples; ~1.3ms at 48kHz/64 samples. Real-world safe limit is ~50-70% of the period to avoid glitches.
