/*
    MultiScoper - Color Picker Component
...
public:
    ...
    explicit MultiScoperColorPicker(IThemeService& themeService, const juce::String& testId = "");
    ~MultiScoperColorPicker() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MultiScoperColorPicker)
};
