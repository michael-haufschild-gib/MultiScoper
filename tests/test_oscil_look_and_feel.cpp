/*
    ...
    in sync with Oscil themes — without these mappings, dark themes leak
...
TEST(OscilLookAndFeelTest, LabelTokensMapToThemeOnApply)
{
    OscilLookAndFeel laf;
...
TEST(OscilLookAndFeelTest, ListBoxTokensMapToTheme)
{
    OscilLookAndFeel laf;
    auto theme = makeCanonicalTheme();
    laf.applyTheme(theme);
...
TEST(OscilLookAndFeelTest, TextEditorFocusOutlineUsesAccent)
{
    OscilLookAndFeel laf;
    auto theme = makeCanonicalTheme();
    laf.applyTheme(theme);
...
TEST(OscilLookAndFeelTest, TextEditorHighlightUsesAccentAt30PercentAlpha)
{
    OscilLookAndFeel laf;
    auto theme = makeCanonicalTheme();
    laf.applyTheme(theme);
...
TEST(OscilLookAndFeelTest, ComboBoxTokensMapToTheme)
{
    OscilLookAndFeel laf;
    auto theme = makeCanonicalTheme();
    laf.applyTheme(theme);
...
TEST(OscilLookAndFeelTest, PopupMenuTokensMapToTheme)
{
    OscilLookAndFeel laf;
    auto theme = makeCanonicalTheme();
    laf.applyTheme(theme);
...
TEST(OscilLookAndFeelTest, AlertWindowUsesPaneBackground)
{
    OscilLookAndFeel laf;
    auto theme = makeCanonicalTheme();
    laf.applyTheme(theme);
...
TEST(OscilLookAndFeelTest, TextButtonUsesAccentWhenOn)
{
    OscilLookAndFeel laf;
    auto theme = makeCanonicalTheme();
    laf.applyTheme(theme);
...
TEST(OscilLookAndFeelTest, ToggleButtonTickUsesAccent)
{
    OscilLookAndFeel laf;
    auto theme = makeCanonicalTheme();
    laf.applyTheme(theme);
...
TEST(OscilLookAndFeelTest, TooltipWindowUsesSecondaryBackground)
{
    OscilLookAndFeel laf;
    auto theme = makeCanonicalTheme();
    laf.applyTheme(theme);
...
TEST(OscilLookAndFeelTest, ResizableWindowUsesPrimaryBackground)
{
    OscilLookAndFeel laf;
    auto theme = makeCanonicalTheme();
    laf.applyTheme(theme);
...
TEST(OscilLookAndFeelTest, ScrollBarTokensMapToTheme)
{
    OscilLookAndFeel laf;
    auto theme = makeCanonicalTheme();
    laf.applyTheme(theme);
...
TEST(OscilLookAndFeelTest, ApplyThemeIsIdempotent)
{
    OscilLookAndFeel laf;
    auto theme = makeCanonicalTheme();
...
TEST(OscilLookAndFeelTest, DifferentThemesProduceDifferentAccents)
{
    OscilLookAndFeel laf;
