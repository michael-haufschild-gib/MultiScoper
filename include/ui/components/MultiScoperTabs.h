...
public:
    ...
    explicit MultiScoperTabs(IThemeService& themeService);
    MultiScoperTabs(IThemeService& themeService, Orientation orientation);
    MultiScoperTabs(IThemeService& themeService, Orientation orientation, const juce::String& testId);
    ~MultiScoperTabs() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MultiScoperTabs)
};
